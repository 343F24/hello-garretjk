...
THe first thing that I notice is that the video do not display correctly when running them through live server. The other difference is the position of the videos move from a row layout on live server to a column layout on stu
